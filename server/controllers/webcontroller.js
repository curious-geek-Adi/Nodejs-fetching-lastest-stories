class Webcontroller{
    static latetststories=[{ "title": "Amy Schneider’s Jeopardy! Streak Ends at 40 Consecutive Wins and $1.4Million",
    ...
    static getTimeStories=(req,res)=>{
        try{
            res.status(200).json(this.latetststories)
